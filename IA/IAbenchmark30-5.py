...
if __name__ == "__main__":
    ...
    with open("results/IA-resultsd-30-5.txt", "w") as file:
    ...
    with open("convergence/IA-convergenced-30-5.csv", "w") as file:
    ...
    with open("results/IA-resultsd-30-10.txt", "w") as file:
    ...
    with open("convergence/IA-convergenced-30-10.csv", "w") as file:
        for i in range(len(marks)):
            print("{},{}".format(10000*i, marks[i]), file=file)
    ...
    with open("results/IA-resultsd-30-23.txt", "w") as file:
    ...
    with open("convergence/IA-convergenced-30-23.csv", "w") as file:
        for i in range(len(marks)):
            print("{},{}".format(10000*i, marks[i]), file=file)
    ...
    with open("results/IA-resultsd-30-24.txt", "w") as file:
    ...
    with open("convergence/IA-convergenced-30-24.csv", "w") as file:
        for i in range(len(marks)):
            print("{},{}".format(10000*i, marks[i]), file=file)
    ...
    with open("results/IA-resultsd-30-25.txt", "w") as file:
    ...
    with open("convergence/IA-convergenced-30-25.csv", "w") as file:
        for i in range(len(marks)):
            print("{},{}".format(10000*i, marks[i]), file=file)
