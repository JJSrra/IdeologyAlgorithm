...
if __name__ == "__main__":
    ...
    with open("results/IA-results-30-3.txt", "w") as file:
    ...
    with open("convergence/IA-convergence-30-3.csv", "w") as file:
    ...
    with open("results/IA-results-30-8.txt", "w") as file:
    ...
    with open("convergence/IA-convergence-30-8.csv", "w") as file:
        for i in range(len(marks)):
            print("{},{}".format(10000*i, marks[i]), file=file)
    ...
    with open("results/IA-results-30-11.txt", "w") as file:
    ...
    with open("convergence/IA-convergence-30-11.csv", "w") as file:
        for i in range(len(marks)):
            print("{},{}".format(10000*i, marks[i]), file=file)
    ...
    with open("results/IA-results-30-19.txt", "w") as file:
    ...
    with open("convergence/IA-convergence-30-19.csv", "w") as file:
        for i in range(len(marks)):
            print("{},{}".format(10000*i, marks[i]), file=file)
    ...
    with open("results/IA-results-30-20.txt", "w") as file:
    ...
    with open("convergence/IA-convergence-30-20.csv", "w") as file:
        for i in range(len(marks)):
            print("{},{}".format(10000*i, marks[i]), file=file)
