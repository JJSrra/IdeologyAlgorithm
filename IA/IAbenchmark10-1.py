...
if __name__ == "__main__":
    ...
    with open("results/IA-results-10-1.txt", "w") as file:
    ...
    with open("convergence/IA-convergence-10-1.csv", "w") as file:
    ...
    with open("results/IA-results-10-6.txt", "w") as file:
    ...
    with open("convergence/IA-convergence-10-6.csv", "w") as file:
        for i in range(len(marks)):
            print("{},{}".format(10000*i, marks[i]), file=file)
    ...
    with open("results/IA-results-10-14.txt", "w") as file:
    ...
    with open("convergence/IA-convergence-10-14.csv", "w") as file:
        for i in range(len(marks)):
            print("{},{}".format(10000*i, marks[i]), file=file)
    ...
    with open("results/IA-results-10-15.txt", "w") as file:
    ...
    with open("convergence/IA-convergence-10-15.csv", "w") as file:
        for i in range(len(marks)):
            print("{},{}".format(10000*i, marks[i]), file=file)
    ...
    with open("results/IA-results-10-16.txt", "w") as file:
    ...
    with open("convergence/IA-convergence-10-16.csv", "w") as file:
        for i in range(len(marks)):
            print("{},{}".format(10000*i, marks[i]), file=file)
